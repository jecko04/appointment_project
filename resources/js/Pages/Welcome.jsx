    ...
    return (
        <>
            ...
            <div className="bg-gray-50 text-black/50 dark:bg-black dark:text-white/50">
                <img
                    id="background"
                    src="C:\Users\Flor\Downloads\React Images\gradientbg"
                />
                            ...
                            <nav className="-mx-3 flex flex-1 justify-end">
                                {auth.user ? (
                                    ...
                                    <>
                                        ...
                                        <Link
                                        href={route('register')}
                                        className="rounded-md px-3 py-2 text-white bg-[#FF4200] ring-1 ring-transparent transition hover:bg-[#FF4200]/80 focus:outline-none focus-visible:ring-[#FF2D20] dark:text-white dark:bg-[#FF2D20] dark:hover:bg-[#FF2D20]/80 dark:focus-visible:ring-white"
                                    >
                                            Sign Up
                                        </Link>
                                    </>
